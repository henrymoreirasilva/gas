...
@if (empty($sales))
    <div class="container-fluid">
        ...
        <h4>Vendas: Data - Filial - Produto</h4>
        <br />
        <form class="clearfix" id="expressao-form" action="{{ route('admin.sales.relatorios.venda-diaria-produto') }}" method="get">
        ...
        if ($diaAtual != $sale->sale_date) {
            ...
            if ($pagina > 0) {
                $html .= '  <div class="row">
                                ...
                                <div class="col-xs-6 money">'. number_format($totalFilial, 2, ',', '.').'</div>
                            </div>';
